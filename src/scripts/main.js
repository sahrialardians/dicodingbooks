function main() {
    ...
    const getBook = () => {
        ...
        // menetapkan callback jika response success atau error
    ...
    const insertBook = (book) => {
        ...
        // membuat POST request dan menetapkan target
        ...
        // megirimkan request dan menyisipkan JSON.stringify(book) pada body
